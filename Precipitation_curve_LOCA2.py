...
df_max = pd.read_csv('/pscratch/sd/y/yangzhou/CCCA5/LOCA2_subset/region_max_precipitation_all.csv')
df_ave = pd.read_csv('/pscratch/sd/y/yangzhou/CCCA5/LOCA2_subset/region_ave_precipitation_all.csv')

# Load full dataset again for a clean start
df = df_ave

# Define the region of interest
region_focus = "North Coast"   # Change to "North Coast"
